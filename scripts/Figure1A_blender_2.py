    ...
    for line in lines:
        ...
        if label_found:
            ...
            for frame in range(1,T+1):
                ...
                r,g,b = get_rgb(timeseries_val,minval=-3,maxval=3)
...
if __name__ == "__main__":
    comp_dir = '/Volumes/borel.seas.upenn.edu/public/USERS/lkini/aim1/results'
    patient_id = 'HUP075'
    soz_coord_fn = ''
    cres_csv_fn = 'HUP075.Ictal.5.noderes.lowgamma.Movie.csv'
    scale = 0.01
    x0 = 8.94377
    y0 = -11.531066
    z0 = 3.9223785
